...
export default function HomePage() {
	...
	return (
		...
		>
			<section className="flex flex-col gap-[50px] items-center w-full lg:w-3/5" >
				<div className="flex flex-col gap-y-5">

					<h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl">{t('HomePage.title')}</h1>
					<h3 className="text-lg lg:text-2xl">{t('HomePage.subtitle')}</h3>
				</div>

				<div className="w-full flex flex-row justify-center items-center gap-x-3 lg:gap-x-10">
					<div className="flex justify-center" >
						<img src='/img/crawling-baby-transparent.gif' alt="Hero" className="max-h-[100px] lg:max-h-[150px] w-auto" />
					</div>

					<div className="flex gap-x-3 lg:gap-x-10">
						<LinkButton href="/about" className="lg:btn-lg btn-primary">
							{t('Common.learn_more')}
						</LinkButton>
